 ...
 */
final class Version20220825071119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE configuration (id INT AUTO_INCREMENT NOT NULL, locale VARCHAR(16) DEFAULT NULL, currency VARCHAR(3) NOT NULL, configuration_name VARCHAR(80) DEFAULT NULL, configuration_description LONGTEXT DEFAULT NULL, is_current TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, ref VARCHAR(255) NOT NULL, date DATETIME NOT NULL, net_amount NUMERIC(14, 2) NOT NULL, tax_amount NUMERIC(14, 2) NOT NULL, amount NUMERIC(14, 2) NOT NULL, quantity INT NOT NULL, status VARCHAR(16) NOT NULL, first_name VARCHAR(50) DEFAULT NULL, last_name VARCHAR(50) DEFAULT NULL, city VARCHAR(50) DEFAULT NULL, street VARCHAR(100) DEFAULT NULL, postal_code VARCHAR(20) DEFAULT NULL, region VARCHAR(50) DEFAULT NULL, country VARCHAR(2) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, INDEX IDX_F5299398A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE order_component (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, product_id INT NOT NULL, parent_id INT NOT NULL, net_price NUMERIC(14, 2) NOT NULL, price NUMERIC(14, 2) NOT NULL, quantity INT NOT NULL, tax_amount NUMERIC(14, 2) NOT NULL, tax_rate NUMERIC(5, 2) NOT NULL, tax_name VARCHAR(30) DEFAULT NULL, net_amount NUMERIC(14, 2) NOT NULL, amount NUMERIC(14, 2) NOT NULL, name VARCHAR(80) NOT NULL, sku VARCHAR(30) DEFAULT NULL, ean VARCHAR(13) DEFAULT NULL, gtin VARCHAR(14) DEFAULT NULL, isbn VARCHAR(14) DEFAULT NULL, INDEX IDX_F579DAAFA76ED395 (user_id), INDEX IDX_F579DAAF4584665A (product_id), INDEX IDX_F579DAAF727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE order_component ADD CONSTRAINT FK_F579DAAFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE order_component ADD CONSTRAINT FK_F579DAAF4584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE order_component ADD CONSTRAINT FK_F579DAAF727ACA70 FOREIGN KEY (parent_id) REFERENCES `order` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_component DROP FOREIGN KEY FK_F579DAAF727ACA70');
        ...
        $this->addSql('ALTER TABLE order_component DROP FOREIGN KEY FK_F579DAAFA76ED395');
        ...
        $this->addSql('DROP TABLE order_component');
